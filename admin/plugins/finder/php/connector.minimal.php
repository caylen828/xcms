...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'URL'           => str_replace('admin/plugins/finder/php', '', dirname($_SERVER['PHP_SELF'])), // URL to files (REQUIRED)
		...
		array(
			...
			'driver'        => 'Trash',
			'path'          => RootPath.'.trash/',
			'tmbURL'        => str_replace('admin/plugins/finder/php', '', dirname($_SERVER['PHP_SELF'])).'.trash/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
